# HackIIITV UG2020 Submission
This repository contains the rules and code of conduct for __HackIIITV UG2020__.
...
2. Clone your fork, using
    `git clone https://github.com/<your-username>/hackiiitv-ug2020-submissions.git`

3. Change Directory to `hackiiitv-ug2020-submissions`, using
    `cd hackiiitv-ug2020-submissions`

4. Set remote to original repository using
    `git remote add ups https://github.com/iiitv/hackiiitv-ug2020-submissions.git`
